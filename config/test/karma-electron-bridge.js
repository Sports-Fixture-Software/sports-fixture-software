...
// Modified from:
// https://github.com/karma-runner/karma-commonjs/blob/master/src/commonjs_bridge.js
// to support Electron. With Electron npm & core node modules can use
// require() directly.
(function () {
    "use strict";
    ...
    if (window.__cjs_modules_root__ === undefined) throw new Error("Could not find module root path.");
